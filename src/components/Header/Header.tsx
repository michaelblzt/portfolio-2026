...
import { IS_AVAILABLE, RESUME_URL } from '@/lib/constants';
      ...
      <div className={`${styles.wrapper} ${hidden ? styles.wrapperHidden : ''}`}>
        ...
        >
          <div className={styles.left}>
            ...
            <span className={`${styles.status} ${menuOpen ? styles.statusHidden : ''}`}>
              <span
                className={`${styles.dot} ${IS_AVAILABLE ? styles.dotAvailable : ''}`}
                aria-hidden="true"
              />
        ...
        <div className={`${styles.navContent} ${menuOpen ? styles.navContentVisible : ''}`}>
          ...
          <nav className={styles.dropdownNav} aria-label="Mobile navigation">
            <a href="#services" className={styles.dropdownNavLink} onClick={closeMenu}>
              Services
            </a>
            <a href="#projects" className={styles.dropdownNavLink} onClick={closeMenu}>
              Projects
            </a>
            <a href="#contact" className={styles.dropdownNavLink} onClick={closeMenu}>
              Contact
            </a>
            <a
              href={RESUME_URL}
